<template>
<view class="content">
	<view :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#fff","height":"auto"}'>
		<form :style='{"width":"100%","padding":"24rpx","background":"#fff","display":"block","height":"auto"}'>
			<view :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#D9DADC","alignItems":"center","borderRadius":"8rpx","borderWidth":"2rpx","background":"#F8F8F8","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
			...
			<view :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#D9DADC","alignItems":"center","borderRadius":"8rpx","borderWidth":"2rpx","background":"#F8F8F8","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				<picker :style='{"width":"100%","padding":"0 20rpx","flex":"1","height":"auto"}' @change="setIsDoneTap" :value="index" :range="options">
					<view class="uni-picker-type" :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#43B3BE"}'>{{options[index]}}</view>
				</picker>
			</view>
			<view :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#D9DADC","alignItems":"center","borderRadius":"8rpx","borderWidth":"2rpx","background":"#F8F8F8","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				<picker :style='{"width":"100%","padding":"0 20rpx","flex":"1","height":"auto"}' @change="setIsanonTap" :value="index2" :range="options2">
					<view class="uni-picker-type" :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#43B3BE"}'>{{options2[index2]}}</view>
				</picker>
			</view>
			<view :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#D9DADC","alignItems":"center","borderRadius":"8rpx","borderWidth":"2rpx","background":"#F8F8F8","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				<picker :style='{"width":"100%","padding":"0 20rpx","flex":"1","height":"auto"}' @change="setCategoryTap" :value="categoryIndex" range-key="typename" :range="categoryList">
					<view class="uni-picker-type" :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#43B3BE"}'>{{categoryList[categoryIndex].typename}}</view>
				</picker>
			</view>
			...
			<view :style='{"padding":"0","margin":"0 0 20rpx","borderColor":"#D9DADC","alignItems":"center","borderRadius":"8rpx","borderWidth":"2rpx","background":"#F8F8F8","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				<xia-editor :style='{"minHeight":"300rpx","padding":"20rpx","margin":"0px","flex":"1","background":"rgba(255, 255, 255, 0)","height":"auto"}' v-model="forum.content" @editorChange="contentChange" placeholder="内容"></xia-editor>
			</view>
			<view :style='{"width":"100%","justifyContent":"center","display":"flex","height":"auto"}'>
				<button :style='{"border":"0","padding":"0px","margin":"0 20rpx","color":"rgb(255, 255, 255)","background":"#43B3BE","width":"40%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">确认提交</button>
			</view>
		</form>
	</view>
</view>
