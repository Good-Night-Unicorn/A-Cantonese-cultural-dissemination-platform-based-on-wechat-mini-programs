<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		...
		<view :style='{"width":"100%","padding":"0","background":"#F1F5F6"}'>
			<!--header end-->
			<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 24rpx","background":"#43B3BE","display":"flex","height":"auto"}'>
				<view class="search-form round" :style='{"margin":"0 0","position":"relative","flex":"1","background":"none"}'>
					...
					<input :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#000","borderRadius":"10rpx 0 0 10rpx","background":"rgba(255,255,255,0.5)","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
				</view>
			...
			<view class="list" :style='{"padding":"20rpx"}'>
				...
				<view @tap="onDetailTap(item.id)" v-for="(item,index) in list " v-bind:key="index" :style='{"boxShadow":"0 0 0px rgba(0, 0, 0, .3)","padding":"30rpx","margin":"0 0 20rpx","borderRadius":"14rpx","background":"#fff","display":"flex","justifyContent":"space-between"}'>
