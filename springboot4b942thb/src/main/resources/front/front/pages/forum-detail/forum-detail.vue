<template>
	<view :style='{"width":"100%","padding":"20rpx","position":"relative","background":"#F1F5F6"}'>
		<view :style='{"boxShadow":"0 2rpx 16rpx rgba(0,0,0,.3)","borderRadius":"50%","textAlign":"center","bottom":"10%","background":"#43B3BE","width":"60rpx","lineHeight":"60rpx","position":"fixed","right":"5%","height":"60rpx"}' @click="reportClick">
			<span class="icon iconfont icon-zhangjie18" :style='{"color":"#fff"}'></span>
		</view>
		<swiper :style='{"width":"100%","borderRadius":"20rpx","background":"#fff","height":"360rpx"}' class="swiper" :indicator-dots='false' :autoplay='false' :circular='false' indicator-active-color='#000000' indicator-color='rgba(0, 0, 0, .3)' :duration='500' :interval='5000' :vertical='false'>
		...
		<view :style='{"margin":"20rpx 0 0","color":"#000","borderRadius":"20rpx 20rpx 0 0","textAlign":"center","background":"#fff","width":"100%","fontSize":"32rpx","lineHeight":"2","fontWeight":"bold"}'>
			{{forum.title}}
		</view>
		<view :style='{"padding":"20rpx 0","margin":"0","color":"#8D8D8D","textAlign":"center","background":"#fff","fontSize":"20rpx","fontWeight":"700"}'>
			<span class="icon iconfont icon-touxiang18" :style='{"padding":"0 20rpx 0 0","display":"none"}'></span>
			<span :style='{"padding":"0"}'>发布人：</span>
			<span :style='{"padding":"0"}'>{{forum.userid!=userid&&forum.isanon==1?'匿名':forum.username}}</span>
		</view>
		<view class="operateView" :style='{"width":"100%","padding":"20rpx","alignItems":"center","background":"#fff","justifyContent":"space-around","display":"flex"}'>
			<view v-if="!likeType" :style='{"width":"30%","padding":"0 20rpx","color":"#fff","borderRadius":"10rpx","textAlign":"center","background":"#43B3BE"}' @click="likeClick">
				<span class="icon iconfont icon-zan10" :style='{"color":"inherit","lineHeight":"70rpx"}'></span>
				<span :style='{"color":"inherit","lineHeight":"70rpx"}'>赞({{allZan}})</span>
			</view>
			<view v-if="likeType" :style='{"width":"30%","padding":"0 20rpx","color":"#fff","borderRadius":"10rpx","textAlign":"center","background":"#43B3BE"}' @click="likeClick">
				<span class="icon iconfont icon-zan10" :style='{"color":"inherit","lineHeight":"70rpx"}'></span>
				<span :style='{"color":"inherit","lineHeight":"70rpx"}'>取消赞({{allZan}})</span>
			</view>
			<view v-if="!collectType" :style='{"width":"30%","padding":"0 20rpx","color":"#fff","borderRadius":"10rpx","textAlign":"center","background":"#43B3BE"}' @click="collectClick">
				<span class="icon iconfont icon-shoucang10" :style='{"color":"inherit","lineHeight":"70rpx"}'></span>
				<span :style='{"color":"inherit","lineHeight":"70rpx"}'>收藏({{allCollect}})</span>
			</view>
			<view v-if="collectType" :style='{"width":"30%","padding":"0 20rpx","color":"#fff","borderRadius":"10rpx","textAlign":"center","background":"#43B3BE"}' @click="collectClick">
				<span class="icon iconfont icon-shoucang10" :style='{"color":"inherit","lineHeight":"70rpx"}'></span>
				<span :style='{"color":"inherit","lineHeight":"70rpx"}'>取消收藏({{allCollect}})</span>
			</view>
		</view>
		<view :style='{"padding":"10rpx 20rpx 20rpx","borderRadius":"0 0 20rpx 20rpx","background":"#fff","width":"100%","letterSpacing":"4rpx","fontSize":"28rpx","lineHeight":"1.5"}'>
			<rich-text :nodes="forum.content"></rich-text>
		</view>
		<view :style='{"padding":"20rpx","margin":"20rpx 0 168rpx","borderRadius":"20rpx","background":"#fff"}'>
			<view :style='{"width":"100%"}' v-for="comment in commentData" :key="comment.id">
				...
				<view :style='{"border":"2rpx solid #eee","padding":"0 20rpx 20rpx 100rpx","fontSize":"28rpx","color":"#333","borderWidth":"0 0 2rpx"}'>
					...
					<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
						<text @tap="onReplyTap(comment.id)" :style='{"padding":"0 20rpx","margin":"0 10rpx 0 0","color":"#fff","borderRadius":"10rpx","background":"#43B3BE","fontSize":"24rpx","lineHeight":"50rpx"}'>回复</text>
						<text @tap="delClick(comment.id)" v-if="userid==comment.userid" :style='{"padding":"0 20rpx","margin":"0","color":"#636363","borderRadius":"10rpx","background":"#D8D8D8","fontSize":"24rpx","lineHeight":"50rpx"}'>删除</text>
					</view>
				</view>
				<view :style='{"width":"100%","padding":"0 0 0 120rpx"}' v-if="comment.childs">
					<view :style='{"width":"100%"}' v-for="item in comment.childs" :key="item.id">
						...
						<view :style='{"border":"2rpx solid #eee","padding":"0 20rpx 20rpx 100rpx","fontSize":"28rpx","color":"#333","borderWidth":"0 0 2rpx"}'>
							...
							<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
								<text :style='{"padding":"0 20rpx","margin":"0","color":"#636363","borderRadius":"10rpx","background":"#D8D8D8","fontSize":"24rpx","lineHeight":"50rpx"}' @tap="delClick(item.id)" v-if="userid==item.userid">删除</text>
							</view>
						</view>
					</view>
				</view>
